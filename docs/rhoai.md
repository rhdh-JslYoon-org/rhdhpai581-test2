...
2) Go to the `Data Science Projects` section and access your application's project named `rhdhpai581-test2`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `rhdhpai581-test2-notebook`.
...
5) In the terminal, run `cd rhdhpai581-test2` to navigate to your sample app's directory.
